...
android {
    namespace = "com.jev.simple"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.jev.simple"
        // 26 covers adaptive icons and every phone the sibling app's users run;
        // the IME needs nothing newer than that.
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
